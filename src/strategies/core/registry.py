...
from ..systems.buy_hold import BuyAndHoldStrategy
from ..systems.published import PublishedSmaCrossStrategy
from ..systems.research import (
    MeanReversionSystem,
...
from ..systems.tuff import TuffSystem
...
STRATEGIES: StrategyRegistry = {
    ...
    "cryptoAdaptiveTrend": CryptoAdaptiveTrendSystem,
    ...
    "managedFuturesMomentum": ManagedFuturesMomentumSystem,
...
STRATEGY_SPECS: StrategySpecRegistry = {
    ...
    "managedFuturesMomentum": StrategySpec(
        ManagedFuturesMomentumSystem,
        parameters={
            "short_lookback": ParameterSpec("short_lookback", default=21, type_=int, minimum=2, optimize_values=[10, 21, 42]),
            "medium_lookback": ParameterSpec("medium_lookback", default=63, type_=int, minimum=3, optimize_values=[42, 63, 84]),
            "long_lookback": ParameterSpec("long_lookback", default=126, type_=int, minimum=5, optimize_values=[84, 126, 168]),
            "macro_lookback": ParameterSpec("macro_lookback", default=252, type_=int, minimum=10, optimize_values=[168, 252, 336]),
            "volatility_lookback": ParameterSpec("volatility_lookback", default=63, type_=int, minimum=5, optimize_values=[42, 63, 126]),
            "target_volatility": ParameterSpec("target_volatility", default=0.15, type_=float, minimum=0.01, maximum=1.0, optimize_values=[0.10, 0.15, 0.20]),
            "max_target_fraction": ParameterSpec("max_target_fraction", default=1.0, type_=float, minimum=0.0, maximum=3.0, optimize_values=[0.50, 1.00, 1.50]),
            "min_signal_strength": ParameterSpec("min_signal_strength", default=0.25, type_=float, minimum=0.0, maximum=1.0, optimize_values=[0.15, 0.25, 0.40]),
            "exit_threshold": ParameterSpec("exit_threshold", default=0.10, type_=float, minimum=0.0, maximum=1.0, optimize_values=[0.00, 0.10, 0.20]),
            "rebalance_interval": ParameterSpec("rebalance_interval", default=21, type_=int, minimum=1, optimize_values=[10, 21, 42]),
            "rebalance_threshold": ParameterSpec("rebalance_threshold", default=0.10, type_=float, minimum=0.0, maximum=1.0, optimize_values=[0.05, 0.10, 0.20]),
            "atr_period": ParameterSpec("atr_period", default=20, type_=int, minimum=2, optimize_values=[14, 20, 30]),
            "atr_stop_multiple": ParameterSpec("atr_stop_multiple", default=4.0, type_=float, minimum=0.1, optimize_values=[3.0, 4.0, 5.0]),
            "commission_bps": ParameterSpec("commission_bps", default=0.0, type_=float, minimum=0.0, optimize_values=[0.0, 1.0, 5.0]),
        },
    ),
    "cryptoAdaptiveTrend": StrategySpec(
        CryptoAdaptiveTrendSystem,
        parameters={
            "fast_ema": ParameterSpec("fast_ema", default=20, type_=int, minimum=2, optimize_values=[10, 20, 30]),
            "slow_ema": ParameterSpec("slow_ema", default=80, type_=int, minimum=3, optimize_values=[50, 80, 120]),
            "momentum_lookback": ParameterSpec("momentum_lookback", default=30, type_=int, minimum=2, optimize_values=[14, 30, 60]),
            "sharpe_lookback": ParameterSpec("sharpe_lookback", default=30, type_=int, minimum=5, optimize_values=[14, 30, 60]),
            "volatility_lookback": ParameterSpec("volatility_lookback", default=30, type_=int, minimum=5, optimize_values=[14, 30, 60]),
            "drawdown_lookback": ParameterSpec("drawdown_lookback", default=90, type_=int, minimum=10, optimize_values=[60, 90, 180]),
            "annualization_bars": ParameterSpec("annualization_bars", default=365, type_=int, minimum=1, optimize_values=[365, 1095, 2190]),
            "target_volatility": ParameterSpec("target_volatility", default=0.45, type_=float, minimum=0.01, maximum=3.0, optimize_values=[0.30, 0.45, 0.70]),
            "max_long_fraction": ParameterSpec("max_long_fraction", default=1.0, type_=float, minimum=0.0, maximum=3.0, optimize_values=[0.50, 1.00, 1.50]),
            "max_short_fraction": ParameterSpec("max_short_fraction", default=0.35, type_=float, minimum=0.0, maximum=1.0, optimize_values=[0.00, 0.20, 0.35]),
            "min_trend_score": ParameterSpec("min_trend_score", default=0.25, type_=float, minimum=0.0, maximum=1.0, optimize_values=[0.15, 0.25, 0.40]),
            "min_rolling_sharpe": ParameterSpec("min_rolling_sharpe", default=0.15, type_=float, minimum=0.0, optimize_values=[0.0, 0.15, 0.30]),
            "max_drawdown_gate": ParameterSpec("max_drawdown_gate", default=-0.45, type_=float, minimum=-1.0, maximum=0.0, optimize_values=[-0.65, -0.45, -0.30]),
            "trailing_atr_multiple": ParameterSpec("trailing_atr_multiple", default=3.0, type_=float, minimum=0.1, optimize_values=[2.0, 3.0, 4.0]),
            "atr_period": ParameterSpec("atr_period", default=14, type_=int, minimum=2, optimize_values=[10, 14, 21]),
            "rebalance_interval": ParameterSpec("rebalance_interval", default=12, type_=int, minimum=1, optimize_values=[6, 12, 24]),
            "rebalance_threshold": ParameterSpec("rebalance_threshold", default=0.12, type_=float, minimum=0.0, maximum=1.0, optimize_values=[0.05, 0.12, 0.25]),
            "allow_short": ParameterSpec("allow_short", default=True, type_=bool),
            "commission_bps": ParameterSpec("commission_bps", default=5.0, type_=float, minimum=0.0, optimize_values=[2.0, 5.0, 10.0]),
        },
    ),
